...
public class LocalSmoothingFilter {
	...
	public static void main(String args[]){
		...
		LocalSmoothingFilter smooth_gpu = new LocalSmoothingFilter(0.01, 100, cl_kernel);
...
//		frame1.paintToPng(50, 20, "gpuinputimage.png");
//		frame2.paintToPng(50, 20, "gpusmoothimg.png");
  ...
  {
    Operator2 a = new A2(_ldk,d,c,s); //No Flops
    scopy(x,y); //copy to the GPU?? No FLOPS
    if (_pc) {
