...
public class SOS_Random_Bench {
	...
	public static void main(String args[]) throws FileNotFoundException 
	{
		...
		//GPU Benchmark
			...
			float[] h_sbe1 = new float[(n1+1)*(n2+1)];
...
//		err = CL.clEnqueueReadBuffer(queue, d_r, CL.CL_TRUE, 0, Sizeof.cl_float*(dims[0]), phdata.to(h_sbe1), 0, null, null);
//		if(err != CL.CL_SUCCESS){
//			System.out.println("Error: Could not read the data from the kernel.");
//			System.out.println("OpenCL error code: " + err);
//			System.exit(1);
