...
public class arraySumCPU {


	
	public float[][] arraySumOpenCLCPU(float[][] array1, float[][] array2, int iters){
	 ...
	 String kernelCode = 
	    ...
	    arr.packArray(n1, n2, array1, pArray1);
	    arr.packArray(n1, n2, array2, pArray2);
	    ...
	    arr.unPackArray(n1, n2, pArray3, array3);
	...
	public static void main(String args[]){
		...
		arraySumCPU run = new arraySumCPU();
		...
		h_cc = run.arraySumOpenCLCPU(h_aa, h_bb, 250);
