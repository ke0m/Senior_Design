...
cpudata   = np.loadtxt("cpuoutput.txt");
cpu2data  = np.loadtxt("cpu2output.txt");

dim3c = len(cpudata[0]);
cpudata3d   = cpudata.reshape(dim3c-4, dim3c-2, dim3c);

dim3c2 = len(cpu2data[0]);
cpu2data3d  = cpu2data.reshape(dim3c2-4, dim3c2-2, dim3c2);

cpudiffimage = abs(cpudata3d - cpu2data3d);
...
m = VolumeSlicer(data=cpudiffimage)
m.configure_traits()
